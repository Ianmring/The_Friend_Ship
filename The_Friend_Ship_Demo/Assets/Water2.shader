...
Shader "Shader Forge/Water2" {
    Properties {
        ...
        _ColorAdjust ("ColorAdjust", Color) = (1,1,1,1)
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
